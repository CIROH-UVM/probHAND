# distutils: sources = external/c-algorithms/src/queue.c
# distutils: include_dirs = external/c-algorithms/src/
...
cdef class Queue:
    """A FIFO queue class for C integer values.
    ...
    Intended to be used in a new HAND algorithm that utilizies a FIFO queue.
    from https://cython.readthedocs.io/en/stable/src/tutorial/clibraries.html
    """
